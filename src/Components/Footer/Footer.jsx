        ...
        <footer className='foot fixed-bottom mt-5'>
            ...
            <div className='footer'>
                <nav className="row">
                    ...
                    <ul className="col-3 col-md-6 list-unstyled justify-content-center align-items-center mx-4"> 
                        <li className="text"> AdminClick</li>
                        <li className="text">Màs Info</li> 
                        <li className="text">Seguinos en Redes</li> 
